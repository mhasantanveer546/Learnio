...
def extract_text_from_image(filepath):
    ...
    Raises ValueError if no readable text is found — same contract as
    the other extractors (pdf_service, docx_service, ppt_service) so
    the dispatcher in text_extraction_service.py can handle all
    formats uniformly."""
